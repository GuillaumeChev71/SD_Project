...
public class PingPongActor extends AbstractActor {
	...
	public void continueGame(ActorRef adversaire, Message message) {
		 ...
		 * S'il rate il prévient l'adversaire avec un message Miss, s'il réussi il renvoie la balle.
		 */
		if (Math.random() > 0.7) {
	...
	public void startGame(ActorRef adversaire) {
		/*
		 * Le joueur démarre le jeu et envoie la balle à son adversaire désigné.
		 */
